...
@section('page_title', 'Edit Data Santri: ' . $santri->nama_lengkap)
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <h2 class="mb-4 text-dark fw-bold">✏️ Edit Santri: {{ $santri->nama_lengkap }}</h2>
            ...
            <div class="card shadow-lg border-0 rounded-4 border-start border-5 border-warning">
                ...
                <div class="card-header bg-primary text-white p-4 rounded-top-4">
                    ...
                    <p class="text-white-50 small mb-0">Lakukan perubahan data untuk santri {{ $santri->nama_lengkap }}.</p>
                </div>
