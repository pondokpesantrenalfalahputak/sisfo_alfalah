...
{{-- Menggunakan nama guru yang diedit untuk judul halaman --}}
@section('page_title', 'Edit Data Guru: ' . $guru->nama_lengkap)
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <h2 class="mb-4 text-dark fw-bold">✏️ Edit Data Guru</h2>

            <div class="card shadow-lg border-0 rounded-4">
                
                {{-- HEADER CARD DENGAN WARNA PRIMER --}}
                <div class="card-header bg-primary text-white p-4 rounded-top-4">
                    <h4 class="mb-0 fw-bold fs-5"><i class="fas fa-edit me-2"></i> Formulir Edit Data Guru</h4>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.guru.update', $guru) }}" method="POST">
                        ...
                        {{-- Bagian I: Informasi Utama --}}
                        <h5 class="fw-bold text-dark mb-4 mt-2 border-bottom pb-2 text-warning"><i class="fas fa-id-card me-2"></i> Informasi Utama</h5>
                        ...
                        <h5 class="fw-bold text-dark mb-4 mt-5 border-bottom pb-2 text-warning"><i class="fas fa-briefcase me-2"></i> Detail Tugas & Kontak</h5>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.guru.index') }}" class="btn btn-outline-secondary px-4 shadow-sm fw-semibold rounded-pill">
                                <i class="fas fa-arrow-left me-2"></i> Kembali ke Daftar
                            </a>
                            <button type="submit" class="btn btn-warning px-4 shadow-lg fw-bold text-dark rounded-pill">
                                <i class="fas fa-redo me-2"></i> Update Data Guru
                            </button>
                        </div>
                    </form>
                </div>
