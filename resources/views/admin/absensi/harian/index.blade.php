                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-4">
                        @forelse ($kelasList as $id => $nama)
                            @php
                                // 🔄 LOGIKA WARNA DAN LEVEL DISINKRONKAN DENGAN MOCK ID (1-3=MTs, 4-6=MA, 7=Mutakhorijin)
                                $color = match (true) {
                                    $id >= 1 && $id <= 3 => 'success',   // MTs (Kelas 7, 8, 9)
                                    $id >= 4 && $id <= 6 => 'info',      // MA (Kelas 10, 11, 12)
                                    $id == 7 => 'danger',              // Mutakhorijin
                                    default => 'secondary',
                                };
                                
                                $level = match (true) {
                                    $id >= 1 && $id <= 3 => 'MTs (Tsanawiyah)',
                                    $id >= 4 && $id <= 6 => 'MA (Aliyah)',
                                    $id == 7 => 'Mutakhorijin',
