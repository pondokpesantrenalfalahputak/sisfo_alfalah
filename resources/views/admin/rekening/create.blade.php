...
@section('page_title', 'Tambah Rekening Pembayaran Baru')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group"> 
                                    ...
                                    <input type="text" name="nama_bank" id="nama_bank" 
                                           ...
                                           placeholder="Contoh: BRI, Mandiri, BNI" value="{{ old('nama_bank') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group"> 
                                    ...
                                    <input type="text" name="atas_nama" id="atas_nama" 
                                           ...
                                           placeholder="Masukkan Nama Lengkap Sesuai Rekening" value="{{ old('atas_nama') }}" required>
