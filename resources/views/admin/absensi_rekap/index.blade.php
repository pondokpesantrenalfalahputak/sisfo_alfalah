...
<style>
    ...
    /* Styling untuk Tabel Responsif Mobile */
    @media (max-width: 767.98px) {
        /* Memaksa Tabel terlihat seperti list view di Mobile (Standard Table Breakpoint) */
        ...
        /* Penataan khusus untuk kolom Alpha dan Aksi di Mobile */
        .mobile-label-alpha {
            background-color: #f8d7da; /* Background untuk menonjolkan alpha */
            font-weight: bold !important;
        }
        
        .mobile-label-total {
            background-color: #ffc107; /* Background untuk Total */
            color: #212529;
            font-weight: bold !important;
        }
    }
...
{{-- Batas peringatan Alpha untuk visual highlight --}}
@php
    $alphaWarningLimit = 3; 
@endphp
                                ...
                                <tr class="{{ $rowClass }}">
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <div class="d-flex justify-content-center gap-1">
                                            @include('admin.absensi_rekap.action_buttons', ['absensi' => $absensi])
                                        </div>
                                    </td>
                                </tr>
                                @empty
...
{{-- Action Button Component (Biasanya ditempatkan di file terpisah, tapi disertakan di sini untuk kelengkapan) --}}
@php
    // Definisikan tombol aksi agar bisa dipanggil di dua tempat (Desktop dan Mobile)
    // Dalam implementasi nyata, ini akan menjadi file Blade terpisah (misal: action_buttons.blade.php)
@endphp
@section('action_buttons')
    ...
    function renderActionButtons($absensi) {
        ...
        $santriName = $absensi->santri->nama_lengkap;
    ...
    {{-- Script untuk tombol aksi jika Anda ingin ini berfungsi --}}
    @if (!function_exists('includeActionButtons'))
        @php
        function includeActionButtons($absensi) {
            renderActionButtons($absensi);
        }
        @endphp
    @endif
@endsection
...
@php
// Memperbaiki pemanggilan include action buttons di dalam loop PHP/Blade
// Kita akan memanggilnya secara langsung di dalam blade.
// Karena saya tidak bisa mengedit fungsi Blade secara langsung, 
// saya menggunakan komponen sederhana di dalam loop pada perbaikan di atas.
@endphp