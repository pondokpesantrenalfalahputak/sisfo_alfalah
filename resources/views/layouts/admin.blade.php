...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('Images/kop pondok.png') }}" sizes="192x192" />
    ...
    <aside id="sidebar" class="d-flex flex-column">
        ...
        <div class="p-4 border-bottom border-light border-opacity-25 d-flex flex-column align-items-center"> 
            <a href="{{ route($dashboardRoute) }}" class="text-decoration-none text-center"> 
                ...
                <small class="text-white-50 small-text">Panel {{ $isAdmin ? 'Admin' : 'Wali Santri' }}</small>
            </a>
        </div>
        ...
        <nav class="pt-3 pb-3 flex-grow-1 overflow-auto">
            ...
            <ul class="nav flex-column px-3"> 
                ...
                @else
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $isActive('wali.notifications.index') }}" href="{{ route('wali.notifications.index') }}">
    ...
    <main id="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top navbar-top">
            <div class="container-fluid"> 
                ...
                <div class="d-none d-lg-block">
                    <h6 class="text-muted mb-0 small-text">@yield('page_title', $pageTitle)</h6>
                </div>
                ...
                <div class="ms-auto d-flex align-items-center">
                    @auth
                        ...
                        {{-- Notifikasi Lonceng --}}
                        <a href="{{ $isAdmin ? route('admin.tagihan.konfirmasi.index') : route('wali.notifications.index') }}" 
                           class="notification-btn text-dark position-relative me-2 p-3" 
                           title="{{ $isAdmin ? 'Konfirmasi Pembayaran' : 'Notifikasi Anda' }}"
                           style="line-height: 1;">
                    ...
                    <nav aria-label="breadcrumb" class="mt-1">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route($dashboardRoute) }}" class="text-decoration-none small-text">
                            ...
                            <li class="breadcrumb-item active text-primary fw-semibold small-text" aria-current="page">@yield('page_title', $pageTitle)</li>
                        </ol>
                    </nav>
                </div>
        ...
        <footer class="bg-white border-top mt-auto py-3">
            <div class="container-fluid text-center small-text text-muted">
                <p class="mb-0">&copy; {{ date('Y') }} SISFO Al-Falah Putak.</p>
            </div>
        </footer>
    </main>
