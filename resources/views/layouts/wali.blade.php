...
<body>
    ...
    @php
        ...
        if (\Illuminate\Support\Str::contains($currentRoute, 'absensi')) $pageTitle = 'Absensi Santri'; // Tambahan
        ...
        <div class="container-fluid px-4 h-100">
            <div class="d-flex align-items-center justify-content-between h-100">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    {{-- Notifikasi Button (Aksen Kuning Emas/Warning) --}}
                    <a href="{{ route('wali.tagihan.index') }}" class="btn btn-link p-0 position-relative text-warning" aria-label="Notifikasi">
                        <i class="fas fa-bell fa-lg"></i>
                        @if($pendingPayments > 0)
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger border border-light" style="font-size: 0.6rem; padding: 5px;">
    ...
    <div class="offcanvas offcanvas-start bg-light d-lg-none" tabindex="-1" id="offcanvasWaliNav" aria-labelledby="offcanvasWaliNavLabel">
        ...
        <div class="offcanvas-header header-custom text-white shadow-lg-custom d-flex flex-column pt-4 pb-3 position-relative">
            ...
            <img src="{{ asset('Images/image.png') }}" alt="Logo Al-Falah" class="offcanvas-logo mb-2">
