...
<?php $__env->startSection('page_title', 'Absensi Harian '); ?>
    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-header bg-primary text-white d-flex flex-column flex-md-row align-items-md-center py-3 px-4 rounded-top-4">
                    <div class="d-flex align-items-center mb-2 mb-md-0">
                        ...
                        <div>
                            ...
                            <small class="badge bg-light text-primary fw-semibold rounded-pill mt-1"><?php echo e($santri->kelas->nama_kelas ?? 'Kelas N/A'); ?> | NISN: <?php echo e($santri->nisn); ?></small>
                        </div>
                    </div>
                    
                    <a href="<?php echo e(route('wali.absensi.index')); ?>" class="btn btn-md btn-light text-primary ms-md-auto fw-bold rounded-pill shadow-sm mt-2 mt-md-0 action-link">
            ...
            <div class="card border-0 shadow-sm bg-white p-4 mb-5 rounded-4 filter-card-custom">
                <form method="GET" action="<?php echo e(route('wali.absensi.show', $santri->id)); ?>" class="row g-3 align-items-center">
                    ...
                    <div class="col-sm-4 col-12">
                        ...
                        <input type="date" name="tanggal" id="tanggal_input" class="form-control form-control-sm rounded-pill shadow-sm" 
                               value="<?php echo e($dateFilter); ?>" max="<?php echo e(Carbon::now()->toDateString()); ?>">
                    </div>
                    ...
                    <div class="col-sm-2 col-6 d-flex align-items-end">
                        <a href="<?php echo e(route('wali.absensi.show', $santri->id)); ?>" class="btn btn-outline-secondary btn-sm flex-fill rounded-pill shadow-sm">Reset</a>
                    </div>
                    <?php endif; ?>


                    
                    <?php if($availableDates->count() > 0): ?>
                    <div class="col-12 mt-4 border-top pt-3">
                        ...
                        <div class="d-flex flex-wrap gap-2 quick-select-dates">
                            <?php $__currentLoopData = $availableDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <a href="<?php echo e(route('wali.absensi.show', ['santri' => $santri->id, 'tanggal' => $date])); ?>" 
                                   class="btn btn-sm <?php echo e($isActive); ?> rounded-pill fw-medium quick-date-item">
                                    <?php echo e(Carbon::parse($date)->translatedFormat('d M')); ?>
            ...
            <div class="mb-4 border-bottom pb-2">
                ...
                <span class="badge bg-info text-white p-2 shadow-sm fs-6 fw-semibold text-nowrap title-date-mobile">
                    <?php echo e(Carbon::parse($dateFilter)->translatedFormat('l, d F Y')); ?>

                </span>
            </div>

            <?php if($absensiHarian->isEmpty()): ?>
            ...
            <?php else: ?>
                ...
                <div class="table-responsive d-none d-md-block shadow-sm rounded-4 overflow-hidden mb-5">
                    <table class="table table-bordered table-sm small table-hover align-middle table-rekap-desktop" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $absensiHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $absensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $statusClass = $statusColorMap[$absensi->status] ?? 'secondary';
                                    $rowClass = ($absensi->status == 'Alfa') ? 'table-danger' : '';
                                ?>
                                <tr class="<?php echo e($rowClass); ?>">
                                    <td class="text-center align-middle fw-bold"><?php echo e($index + 1); ?></td>
                                    <td class="align-middle fw-semibold text-dark"><?php echo e($absensi->jenis_kegiatan); ?></td>
                                    <td class="text-center align-middle">
                                        <span class="badge bg-<?php echo e($statusClass); ?> p-2 shadow-sm fw-bold rounded-pill status-badge"><?php echo e($absensi->status); ?></span>
                                    </td>
                ...
                <div class="d-md-none list-group-detail-mobile mb-5">
                    <div class="list-group">
                        <?php $__currentLoopData = $absensiHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $absensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="list-group-item list-group-item-action mb-3 p-3 rounded-4 border-start-5 border-start-<?php echo e($statusClass); ?> <?php echo e($borderClass); ?> list-item-custom">
                                
                                
                                <div class="d-flex w-100 justify-content-between align-items-center mb-2">
                                    <h6 class="mb-0 fw-bold text-dark flex-grow-1 text-truncate">
                                        <?php echo e($index + 1); ?>. <?php echo e($absensi->jenis_kegiatan); ?>

                                    </h6>
                                    <span class="badge bg-<?php echo e($statusClass); ?> py-2 px-3 fw-bold rounded-pill shadow-sm status-badge-mobile ms-2 flex-shrink-0">
                                ...
                                <div class="small text-muted keterangan-mobile">
                                    ...
                                    <p class="mb-0 text-wrap ms-3 fst-italic text-secondary description-text">
                                        <?php echo e($absensi->keterangan ?? 'Tidak ada catatan.'); ?>
...
<?php echo $__env->make('layouts.wali', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/axioo/Unduhan/_sisfo-laravel/resources/views/wali/absensi/show.blade.php ENDPATH**/ ?>