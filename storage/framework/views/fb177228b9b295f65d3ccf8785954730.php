...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('wali.pengumuman.index')); ?>" class="btn btn-sm btn-outline-secondary rounded-pill px-3 shadow-sm">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4 border-top border-4 <?php echo e($borderColor); ?>">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-lg border-0 rounded-4 border-top border-4 <?php echo e($borderColor); ?> mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <p class="small text-muted mb-1">
                            <i class="<?php echo e($iconClass); ?> me-1 text-<?php echo e($colorClass); ?>"></i> Kategori
                        </p>
                        <span class="badge bg-<?php echo e($colorClass); ?> fw-bold py-2 px-3 fs-6 rounded-pill">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="fw-semibold text-dark fs-6"><?php echo e($formattedDate); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    ...
                    <a href="<?php echo e($whatsappUrl); ?>" target="_blank" class="btn btn-success w-100 btn-md rounded-pill mb-3">
                    ...
                    <a href="<?php echo e(route('wali.pengumuman.index')); ?>" class="btn btn-light w-100 btn-md rounded-pill mt-3 text-secondary">
