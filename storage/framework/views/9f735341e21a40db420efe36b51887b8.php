...
<head>
    ...
    <title>Pondok Pesantren Modern Al-Falah Putak</title>
...
<body>
            ...
            <div class="container-fluid px-0">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-none d-lg-flex align-items-center">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary me-2">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-teal">Registrasi</a>
                    </div>

                    
                    <div class="d-lg-none mobile-buttons">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary w-100 mb-2">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-teal w-100">Registrasi</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <main class="main-content">
        ...
        <section class="hero-section text-white" style="background-image: url('<?php echo e(asset('Images/Gambar WhatsApp 2025-08-08 pukul 19.51.39_1513872e.jpg')); ?>');">
    ...
    <footer id="kontak" class="footer-custom text-white">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li><a href="<?php echo e(route('login')); ?>" class="text-white-50 text-decoration-none">Login Panel</a></li>
                    </ul>
                </div>
                <div class="col-md-6 col-lg-4">
        ...
        <div class="bg-dark py-3">
            <div class="container text-center small text-white-50">
                &copy; <?php echo e(date('Y')); ?> Al-Falah Putak. Hak Cipta Dilindungi.
            </div>
        </div>
    </footer>
...
</html><?php /**PATH /home/u746452968/domains/sisfoalfalahputak.online/sisfo-laravel/resources/views/welcome.blade.php ENDPATH**/ ?>