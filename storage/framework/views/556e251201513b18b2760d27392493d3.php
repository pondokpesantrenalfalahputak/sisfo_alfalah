...
<?php $__env->startSection('page_title', 'Manajemen Tagihan Pembayaran'); ?>
...
<?php $__env->startSection('header_actions'); ?>
    ...
    <a href="<?php echo e(route('admin.tagihan.create')); ?>" class="btn btn-warning shadow-lg rounded-pill d-none d-md-flex align-items-center fw-bold px-4 py-2 text-dark">
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <a href="<?php echo e(route('admin.tagihan.create')); ?>" class="btn btn-warning shadow-lg rounded-pill d-flex align-items-center justify-content-center fw-bold px-4 py-2 text-dark d-block d-md-none">
                <i class="fas fa-plus me-2"></i> Buat Tagihan Baru
            </a>
                ...
                <div class="card-body p-4 border-start border-5 border-primary rounded-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h2 fw-bolder mb-0 text-dark"><?php echo e(number_format($totalTagihan, 0, ',', '.')); ?></div>
                        </div>
                ...
                <div class="card-body p-4 border-start border-5 border-danger rounded-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h2 fw-bolder mb-0 text-dark"><?php echo e(number_format($belumLunas, 0, ',', '.')); ?></div>
                        </div>
                ...
                <div class="card-body p-4 border-start border-5 border-success rounded-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h2 fw-bolder mb-0 text-dark"><?php echo e(number_format($lunas, 0, ',', '.')); ?></div>
                        </div>
                ...
                <div class="card-body p-4 border-start border-5 border-info rounded-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="h4 fw-bolder mb-0 text-dark">Rp <?php echo e(number_format($totalNominal, 0, ',', '.')); ?></div>
                        </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="table-responsive d-none d-md-block">
                <table class="table table-hover table-striped align-middle mb-0" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $tagihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="text-center"><?php echo e($index + 1); ?></td>
                                <td>
                                    <div class="fw-bolder text-dark"><?php echo e($tagihan->santri->nama_lengkap ?? 'N/A'); ?></div>
                                    <small class="text-secondary"><i class="fas fa-school me-1"></i> <?php echo e($tagihan->santri->kelas->nama_kelas ?? 'N/A'); ?></small>
                                </td>
                                <td>
                                    <span class="badge bg-secondary p-2 fw-semibold rounded-pill"><?php echo e($tagihan->jenis_tagihan); ?></span>
                                </td>
                                <td class="text-end fw-bolder text-primary">
                                    Rp <?php echo e(number_format($tagihan->jumlah_tagihan, 0, ',', '.')); ?>

                                </td>
                                <td><small class="text-muted"><?php echo e(\Carbon\Carbon::parse($tagihan->tanggal_tagihan)->translatedFormat('d M Y')); ?></small></td>
                                <td>
                                    <?php
                                        $dueDate = \Carbon\Carbon::parse($tagihan->tanggal_jatuh_tempo);
                                        $isOverdue = $tagihan->status != 'Lunas' && $dueDate->isPast();
                                    ?>
                                    <span class="<?php echo e($isOverdue ? 'fw-bolder text-danger' : 'text-success'); ?>">
                                        <?php echo e($dueDate->translatedFormat('d M Y')); ?>
                                ...
                                <td class="text-center text-nowrap">
                                    ...
                                    <a href="<?php echo e(route('admin.tagihan.show', $tagihan)); ?>" class="btn btn-primary btn-sm rounded-pill shadow-sm me-1" title="Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.tagihan.edit', $tagihan)); ?>" class="btn btn-warning btn-sm rounded-pill shadow-sm me-1" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.tagihan.destroy', $tagihan)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="d-md-none px-0">
                    ...
                    <div class="card mb-3 mobile-tagihan-card rounded-3 border-start border-2 <?php echo e($statusClass); ?>">
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-start border-bottom pb-2 mb-2">
                                <div>
                                    <h6 class="mb-0 mobile-detail-text"><i class="fas fa-hashtag me-1"></i> ID <?php echo e($index + 1); ?></h6>
                                    
                                    <h5 class="card-title text-dark mb-0 mobile-card-title"><?php echo e($tagihan->santri->nama_lengkap ?? 'N/A'); ?></h5>
                                    <small class="mobile-detail-text"><i class="fas fa-school me-1"></i> Kelas: <?php echo e($tagihan->santri->kelas->nama_kelas ?? 'N/A'); ?></small>
                                </div>
                                <div class="text-end">
                            ...
                            <div class="row pt-2 pb-2 align-items-center">
                                <div class="col-6">
                                    ...
                                    <span class="fw-bolder mobile-amount-text text-primary">Rp <?php echo e(number_format($tagihan->jumlah_tagihan, 0, ',', '.')); ?></span>
                                </div>
                                <div class="col-6 text-end">
                                    <h6 class="mobile-detail-text mb-1 text-uppercase">Jenis Tagihan</h6>
                                    
                                    <span class="badge bg-secondary mobile-badge fw-semibold rounded-pill"><?php echo e($tagihan->jenis_tagihan); ?></span>
                                </div>
                            </div>
                            <hr class="my-2">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    ...
                                    <small class="fw-semibold mobile-detail-text"><?php echo e(\Carbon\Carbon::parse($tagihan->tanggal_tagihan)->translatedFormat('d M Y')); ?></small>
                                </div>
                                <div class="text-end">
                                    <h6 class="mobile-detail-text mb-1 text-uppercase">Jatuh Tempo</h6>
                                    
                                    <span class="<?php echo e($isOverdue ? 'fw-bolder text-danger' : 'fw-bold text-success'); ?> mobile-detail-text">
                                        <?php echo e($dueDate->translatedFormat('d M Y')); ?>
                            ...
                            <div class="d-grid gap-2 d-sm-flex justify-content-sm-end pt-2 border-top">
                                <a href="<?php echo e(route('admin.tagihan.show', $tagihan)); ?>" class="btn btn-sm btn-primary fw-semibold rounded-pill mobile-action-btn" title="Detail">
                                    <i class="fas fa-eye me-1"></i> Detail
                                </a>
                                <a href="<?php echo e(route('admin.tagihan.edit', $tagihan)); ?>" class="btn btn-sm btn-warning fw-semibold rounded-pill mobile-action-btn" title="Edit Data">
                                    <i class="fas fa-edit me-1"></i> Edit
                                </a>
                                
                                <form action="<?php echo e(route('admin.tagihan.destroy', $tagihan)); ?>" method="POST" class="d-inline d-grid">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-5 text-muted bg-light rounded-3 shadow-sm">
                        ...
                        <h5 class="mb-0 fw-bold">Tidak ada data tagihan yang ditemukan.</h5>
                        <p class="mb-0 mt-2">Silakan klik tombol "Buat Tagihan Baru" di atas untuk memulai.</p>
                        <a href="<?php echo e(route('admin.tagihan.create')); ?>" class="btn btn-sm btn-primary mt-3 rounded-pill px-3">Buat Tagihan Pertama</a>
                    </div>
                <?php endif; ?>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/axioo/Unduhan/_sisfo-laravel/resources/views/admin/tagihan/index.blade.php ENDPATH**/ ?>