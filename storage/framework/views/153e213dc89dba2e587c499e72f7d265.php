...
<?php $__env->startSection('page_title', 'Edit Data Rekening Bank'); ?>
        ...
        <div class="col-12">
            ...
            <div class="card shadow-lg border-0 rounded-4 border-start border-5 border-warning">
                ...
                <div class="card-header bg-primary text-white p-4 rounded-top-4">
                    <h4 class="mb-0 fw-bold fs-5"><i class="fas fa-edit me-2"></i> Edit Rekening: <?php echo e($rekening->nama_bank); ?></h4>
                    <p class="text-white-50 small mb-0">Perbarui informasi rekening bank. Nomor rekening ini saat ini: <strong class="text-white"><?php echo e($rekening->nomor_rekening); ?></strong></p>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('admin.rekening.update', $rekening)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           placeholder="Contoh: BRI, Mandiri" value="<?php echo e(old('nama_bank', $rekening->nama_bank)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           placeholder="Masukkan Nama Lengkap Sesuai Rekening" value="<?php echo e(old('atas_nama', $rekening->atas_nama)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              rows="3"><?php echo e(old('keterangan', $rekening->keterangan)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/axioo/Unduhan/_sisfo-laravel/resources/views/admin/rekening/edit.blade.php ENDPATH**/ ?>