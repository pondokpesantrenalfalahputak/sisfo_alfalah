...
<?php $__env->startSection('page_title', 'Rincian Tagihan Pembayaran'); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow-lg border-0 rounded-4 mb-4 border-start border-5 border-primary">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="p-4 mb-4 border border-2 <?php echo e($tagihan->status == 'Lunas' ? 'border-success bg-success-subtle' : 'border-danger bg-danger-subtle'); ?> rounded-3 shadow-sm">
                        <h6 class="fw-bold text-muted mb-1 text-uppercase small">Total Tagihan</h6>
                        <p class="lead fw-bolder mb-3 fs-1 <?php echo e($tagihan->status == 'Lunas' ? 'text-success' : 'text-danger'); ?>">
                            Rp <?php echo e(number_format($tagihan->jumlah_tagihan, 0, ',', '.')); ?>

                        </p>
                        
                        <h6 class="fw-bold text-muted mb-1 text-uppercase small">Status</h6>
                        <span class="badge <?php echo e($tagihan->status == 'Lunas' ? 'bg-success' : 'bg-warning text-dark'); ?> p-3 fs-6 fw-bold">
                            <i class="fas <?php echo e($tagihan->status == 'Lunas' ? 'fa-check-circle' : 'fa-clock'); ?> me-2"></i>
                    ...
                    <ul class="list-group list-group-flush border rounded-3">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="fw-semibold text-dark"><?php echo e($tagihan->id); ?></div>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="text-muted small">Jenis Tagihan</div>
                            <div class="fw-semibold text-dark"><?php echo e($tagihan->jenis_tagihan); ?></div>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="text-muted small">Tanggal Dibuat</div>
                            <div class="fw-semibold text-dark"><?php echo e(\Carbon\Carbon::parse($tagihan->tanggal_tagihan)->translatedFormat('d F Y')); ?></div>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            ?>
                            <div class="fw-bolder <?php echo e($isOverdue ? 'text-danger' : 'text-dark'); ?>">
                                <?php echo e($dueDate->translatedFormat('d F Y')); ?>
                        ...
                        <li class="list-group-item">
                            ...
                            <p class="mb-0 fst-italic text-wrap text-secondary"><?php echo e($tagihan->keterangan ?? 'Tidak ada keterangan.'); ?></p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="card-footer bg-light border-0 rounded-bottom-4 p-4">
                    <div class="d-flex justify-content-end gap-2 flex-column flex-sm-row"> 
                        <a href="<?php echo e(route('admin.tagihan.edit', $tagihan)); ?>" class="btn btn-warning shadow-sm fw-bold rounded-pill px-4 text-dark order-sm-1 order-2">
                            <i class="fas fa-edit me-2"></i> Edit Data
                        </a>
                        
                        <form action="<?php echo e(route('admin.tagihan.destroy', $tagihan)); ?>" method="POST" class="d-inline w-100 w-sm-auto order-sm-2 order-1">
                            <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-6">
                ...
                <div class="card-body p-4">
                    ...
                    <ul class="list-group list-group-flush border rounded-3">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="fw-bold text-dark"><?php echo e($tagihan->santri->nama_lengkap ?? $tagihan->santri->nama ?? 'N/A'); ?></div>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="text-muted small">Kelas</div>
                            <div class="fw-semibold text-secondary"><?php echo e($tagihan->santri->kelas->nama_kelas ?? 'N/A'); ?></div>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="text-muted small">Wali Santri</div>
                            <div class="fw-semibold text-dark"><?php echo e($tagihan->santri->waliSantri->name ?? 'N/A'); ?></div>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card shadow-lg border-0 rounded-4 border-start border-5 border-success">
                ...
                <div class="card-body p-4">
                    <?php if($tagihan->pembayarans->isEmpty()): ?>
                            ...
                            <table class="table table-sm table-striped table-hover align-middle mb-0 border">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $tagihan->pembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><small class="text-muted"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal_bayar ?? $pembayaran->created_at)->format('d/m/Y')); ?></small></td>
                                            <td class="text-end fw-bold text-primary">Rp <?php echo e(number_format($pembayaran->jumlah_bayar, 0, ',', '.')); ?></td>
                                            <td><small><?php echo e($pembayaran->metode_pembayaran); ?></small></td>
                                            <td class="text-center">
                                                <?php
                                                    $status = $pembayaran->status_konfirmasi;
                                                    $class = $status == 'Dikonfirmasi' ? 'success' : ($status == 'Ditolak' ? 'danger' : 'warning text-dark');
                                                ?>
                                                <span class="badge bg-<?php echo e($class); ?> fw-semibold"><?php echo e($status); ?></span>
                                            </td>
                                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/axioo/Unduhan/_sisfo-laravel/resources/views/admin/tagihan/show.blade.php ENDPATH**/ ?>